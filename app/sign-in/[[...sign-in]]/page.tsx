 ...
 *
 * The catch-all `[[...sign-in]]` segment is required so Clerk's internal
 * sub-routes (factor-one, verification, sso-callback, etc.) all resolve
 * here. We just brand the surrounding page; Clerk renders the form.
 */
